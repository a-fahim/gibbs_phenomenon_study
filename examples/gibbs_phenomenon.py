...
from gibbs_phenomenon_study.solvers import wave_equation_rk4
from gibbs_phenomenon_study.solvers import advection_equation_solver
from gibbs_phenomenon_study.utils.visualization import make_animation
from gibbs_phenomenon_study.utils.initial_conditions import right_triangle_initial_condition, square_pulse_initial_condition
...
def run_gibbs_phenomenon_simulation(initial_condition_type="triangle", resolution=0.001):
    ...
    time_domain_length = 0.1
    k = resolution  # Same resolution for time and space
